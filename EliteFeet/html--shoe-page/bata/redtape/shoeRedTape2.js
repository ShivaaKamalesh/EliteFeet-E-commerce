...
var formalImgs = document.querySelector(".formal-imgs");
...
function onInIt(ArrProductsNew){
    ...
    ArrProductsNew.forEach((item,key)=>{
        ...
        div.classList.add("formal-img");

      div.innerHTML = ` <img src="./images/redTapeFormalShoes/redTapeFormalShoe${item.id}.webp"
            class="formal-img-${item.id}"/>
...
function reloadCart(){
    ...
    checkOutList.forEach((item,key)=>{
        ...
        li.innerHTML = `
        <img src="./images/redTapeFormalShoes/redTapeFormalShoe${item.id}.webp">
        <div>${item.name}</div>
        <div>${item.price}</div>
        <div>
...
var redTapeFormals = document.querySelector('.redTape-formals');
// var search = document.querySelector('.search-bar-input');
var productList = redTapeFormals.querySelectorAll('.formal-img');
// var formalImgs = document.querySelector('.formal-imgs');
let enteredValue = "";
