...
var redTapeCasualImgs = document.querySelector(".redTape-casuals-imgs");
...
function onInIt(ArrProductsNew){
    ...
    redTapeCasualImgs.innerHTML = '';

    ArrProductsNew.forEach((item,key)=>{
        let div = document.createElement("div");
        div.classList.add("redTape-casuals-img");

      div.innerHTML = ` <img src="./images/redTapeCasualShoes/redTapeCasualShoe${item.id}.webp"
            class="redTape-casuals-img-${item.id}"/>
            <div class="info-whist-cart">
                <div class="redTape-casuals-info">
                    <h3>${item.brand}</h3>
                    <p>${item.name}</p>
                    <h5>Rs. ${item.price}</h5>
                </div>
            ...
            redTapeCasualImgs.appendChild(div);
    });
...
function reloadCart(){
    ...
    checkOutList.forEach((item,key)=>{
        ...
        li.innerHTML = `
        <img src="./images/redTapeCasualShoes/redTapeCasualShoe${item.id}.webp">
        <div>${item.name}</div>
        <div>${item.price}</div>
        <div>
...
var redTapeCasuals = document.querySelector('.redTape-casuals');
// var search = document.querySelector('.search-bar-input');
var productList = redTapeCasuals.querySelectorAll('.redTape-casuals-img');
var redTapeCasualImgs = document.querySelector('.redTape-casuals-imgs');
let enteredValue = "";
...
//         }
//         redTapeCasualImgs.style.justifyContent = 'space-around';
//     }
//    else{
...
//         else{
//             productList[count].style.display = 'block';
//             redTapeCasualImgs.style.justifyContent = 'flex-start';
//         }
//     }
//    }
