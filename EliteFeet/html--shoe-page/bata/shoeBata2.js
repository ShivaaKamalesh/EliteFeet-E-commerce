...
var formalImgs = document.querySelector(".bataFormalShoes-imgs");
...
function onInIt(ArrProductsNew){
    ...
    formalImgs.innerHTML = '';

    ArrProductsNew.forEach((item,key)=>{
        let div = document.createElement("div");
        div.classList.add("bataFormalShoes-img");

      div.innerHTML = ` <img src="./images/bataFormalShoes/bataFormalShoe${item.id}.jpeg"
            class="bataFormalShoes-img-${item.id}"/>
            <div class="info-whist-cart">
                <div class="bata-formals-info">
                    <h3>${item.brand}</h3>
                    <p>${item.name}</p>
                    <h5>Rs. ${item.price}</h5>
                </div>
...
function reloadCart(){
    ...
    checkOutList.forEach((item,key)=>{
        ...
        li.innerHTML = `
        <img src="./images/bataFormalShoes/bataFormalShoe${item.id}.jpeg">
        <div>${item.name}</div>
        <div>${item.price}</div>
        <div>
...
var bataFormals = document.querySelector('.bata-formals');
// var search = document.querySelector('.search-bar-input');
var productList = bataFormals.querySelectorAll('.bataFormalShoes-img');
// var formalImgs = document.querySelector('.bataFormalShoes-imgs');
let enteredValue = '';
...
//         }
//         formalImgs.style.justifyContent = 'space-around';
//     }
//    else{
...
//         else{
//             productList[count].style.display = 'block';
//             formalImgs.style.justifyContent = 'flex-start';
//         }
//     }
//    }
