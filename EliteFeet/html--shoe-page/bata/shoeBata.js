...
var bataSportsImgs = document.querySelector(".bata-sports-imgs");
...
function onInIt(ArrProductsNew){
    ...
    bataSportsImgs.innerHTML = '';

    ArrProductsNew.forEach((item,key)=>{
        let div = document.createElement("div");
        div.classList.add("bata-sports-img");

      div.innerHTML = ` <img src="./images/bataSportsShoes/bataSportsShoe${item.id}.jpeg"
            class="bata-sports-img-${item.id}"/>
            <div class="info-whist-cart">
                <div class="bata-sports-info">
                    <h3>${item.brand}</h3>
                    <p>${item.name}</p>
                    <h5>Rs. ${item.price}</h5>
                </div>
            ...
            bataSportsImgs.appendChild(div);
    });
...
function reloadCart(){
    ...
    checkOutList.forEach((item,key)=>{
        ...
        li.innerHTML = `
        <img src="./images/bataSportsShoes/bataSportsShoe${item.id}.jpeg">
        <div>${item.name}</div>
        <div>${item.price}</div>
        <div>
...
var bataSports = document.querySelector('.bata-sports');
// var search = document.querySelector('.search-bar-input');
var productList = bataSports.querySelectorAll('.bata-sports-img');
// var bataSportsImgs = document.querySelector('.bata-sports-imgs');
let enteredValue = "";
...
//         }
//         bataSportsImgs.style.justifyContent = 'space-around';
//     }
//    else{
...
//         else{
//             productList[count].style.display = 'block';
//             bataSportsImgs.style.justifyContent = 'flex-start';
//         }
//     }
//    }
